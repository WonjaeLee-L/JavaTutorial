...
public class _00_타자게임 {
	...
	public static void main(String[] args) {
		...
		String[] arrLevel4 = {"astonish","lift","punish","angle","dress","fire","fowl","volleyball","shrill","squealing","frighten","wnader","learning","squirrel","gainful","crack","reflective","stream","rotten","icicle","bring","imperfect","cower"};
